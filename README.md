...
Parrot Admin is a customizable Drupal 7 administrative theme, which is using the same great structure that Parrot (https://github.com/bmx269/parrot) uses, but now is for the Drupal admin area. Like the other theme, Parrot Admin sits on the shoulders of some great projects. Parrot is a Drupal 7 Mothership subtheme that uses "some" Bootstrap CSS structure, with SASS & Compass.
...
To install, copy the folder "parrot_admin" from this repo into /sites/all/themes/ of your Drupal 7 site. You can then edit the .info file add your Fancy theme title. Renaming is not required for use.
